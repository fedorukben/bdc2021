...
g.d['parler-kw'] = pd.read_pickle('../data/pickle/Parler-name-filter.pkl')
...
fig = sns.histplot(data=g.d['twitter'], x='compound', bins=25, kde=True)
...
fig.set(xlabel='compounded positivity score on [-1, 1]', 
        ...
        title='Parler Frequency of Positivity by Keyword')
